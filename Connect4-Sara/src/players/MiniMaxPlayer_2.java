 ...
 *  
 */
public class MiniMaxPlayer_2 extends AbstractPlayer {
...
//			System.out.println("lastMove p2:" + "("+last_move[0]+ ","+ last_move[1]+")" + " Human Running Total:"+ P2RunningTotal);
...
//			System.out.println("lastMove p1:" + "("+last_move[0]+ ","+ last_move[1]+")" + " Human Running Total:"+ P1RunningTotal);
...
//			System.out.println("Position of Move = " + move + " ("  +grid[x][y]+ "):: "
...
//			System.out.println("&&&&&&&&&&&  moves out of range &&&&&&&&&&");
			int i=1;
...
//						System.out.println("Adding move " + move + " (" + value + ")");
						possibleMoves.add(move);
						searching = false;
